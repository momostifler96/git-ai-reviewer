export const DEFAULT_REVIEW_SYSTEM_PROMPT = `You are a senior software engineer performing a code review on uncommitted Git changes.
...
export const DEFAULT_COMMIT_SYSTEM_PROMPT = `You are an expert at writing high-quality Git commit messages.
